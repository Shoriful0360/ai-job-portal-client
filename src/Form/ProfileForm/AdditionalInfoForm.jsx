        ...
        {role?.role === "Employer" &&
          <>
            ...
            <div>
              ...
              <select  name="company_type" defaultValue={company_type} className="w-full bg-gray-800 rounded-md p-2">
            ...
            <div>
              <label className="block mb-2 font-medium">Industry</label>
              <select name="size" defaultValue={size} className="w-full bg-gray-800 rounded-md p-2">
            ...
            <div>
              ...
              <input
                type='number'
                defaultValue={founder_year?founder_year:0}
                className="w-full bg-gray-800 p-2 rounded-md"
                name='founder_year'
                placeholder='Enter founder year'
              />
            </div>
            {/* about Company */}
            <div>
        ...
        {role?.role === "Job Seeker" &&
          <>
            ...
            <div>
              ...
              <select name="ageRange"defaultValue={ageRange} className="w-full bg-gray-800 rounded-md p-2">
            ...
            <div>
              ...
              <select name="deviceType" defaultValue={deviceType} className="w-full bg-gray-800 rounded-md p-2">
            ...
            <div>
              ...
              <select name="internetType"  defaultValue={internetType} className="w-full bg-gray-800 rounded-md p-2">
                <option value={internetType}>{internetType}</option>
                <option value="Mobile">Mobile</option>
            ...
            <div>
              ...
              <select name="experience" defaultValue={experience} className="w-full bg-gray-800 rounded-md p-2">
            ...
            <div>
              ...
              <select name="employmentRole" defaultValue={employmentRole} className="w-full bg-gray-800 rounded-md p-2">
                <option value={employmentRole}>{employmentRole}</option>
            ...
            <div>
              ...
              <select name="areaType" defaultValue={areaType} className="w-full bg-gray-800 rounded-md p-2">
