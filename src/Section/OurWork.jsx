...
const OurWork = () => {
    return (
        <div className='sm:my-16 '>
            ...
            <p className='text-sm font-bold text-center my-3 text-gray-600 px-6'>Our AI-powered job portal offers a smart solution for job seekers, helping them find <br className="hidden sm:inline" /> the right job based on their skills and experience.</p>
            <div className='grid lg:grid-cols-2 my-12 px-1 lg:px-7 gap-10 items-center md:px-7 '>
                <motion.div
                    ...
                    className='mt-3'>
                    <div className='bg-[#EDE8E0] px-4 py-1 m-3 rounded-xl mt-auto'>
