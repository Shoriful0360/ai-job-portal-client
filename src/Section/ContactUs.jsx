...
const ContactUs = () => {
    ...
    return (
        <div className="grid lg:grid-cols-2 bg-orange-50 items-center gap-5 my-11 p-4 md:px-10">
            <motion.div
                initial={{ opacity: 0, x: -100 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true, amount: 0.3 }}
                transition={{ duration: 0.8 }} >
                <h3 className='text-3xl font-bold  my-3'>We aim to <span className="text-[#847469]">streamline</span> your job search</h3>
                <p className='text-sm font-semibold flex items-center gap-3 my-3 text-gray-700 '><span className="text-xl text-[#847469] mt-1"><MdOutlineMail /></span>jobvision@gmail.com</p>
                <p className='text-sm font-semibold flex items-center gap-3 my-3 text-gray-700 '><span className="text-xl text-[#847469] mt-1"><FaPhoneVolume /></span>+8801*********</p>
                <form onSubmit={handleSubmit}>
                    <div className="lg:flex gap-6 my-1">
                        <div className="my-1">
                            <label className=" fieldset-label text-sm font-bold text-gray-700 my-1">Your Name</label>
                            <input type="text" name="name" className="input w-full my-1 bg-[#F2F0EC]" required placeholder="Name" />
                        </div>
                        <div className="my-1">
                            <label className=" fieldset-label text-sm font-bold text-gray-700 my-1">Your Contact No</label>
                            <input type="text" name="number" className="input w-full my-1 bg-[#F2F0EC]" required placeholder="Phone No" />
                        </div>

                        <div className="my-1">
                            <label className=" fieldset-label text-sm font-bold my-1 text-gray-700">Your Email</label>
                            <input type="text" name="email" className="input w-full my-1 bg-[#F2F0EC]" required placeholder="Your Email" />
                        </div>
                    </div>
                    <label className=" fieldset-label text-sm font-bold text-gray-700 my-1">Message</label>
                    <textarea className="textarea bg-[#F2F0EC] w-full  lg:w-[600px] my-1" name="massage" placeholder="Type Your Message Here (0/200 Character)"></textarea>
                    <p><button className="px-2 py-1 bg-[#847469] text-sm font-bold text-white rounded-lg mt-3 m ">Submit</button></p>
                </form>
            </motion.div>
            ...
            <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
                transition={{ duration: 0.8 }}>
                <div className="collapse collapse-plus my-4 bg-[#EDE8E0] border border-base-300">
